...
public final class MyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cn.abstractmgs.HelloRequest,
      cn.abstractmgs.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = cn.abstractmgs.HelloRequest.class,
      responseType = cn.abstractmgs.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cn.abstractmgs.HelloRequest,
      cn.abstractmgs.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<cn.abstractmgs.HelloRequest, cn.abstractmgs.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<cn.abstractmgs.HelloRequest, cn.abstractmgs.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.abstractmgs.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.abstractmgs.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(cn.abstractmgs.HelloRequest request,
        io.grpc.stub.StreamObserver<cn.abstractmgs.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                cn.abstractmgs.HelloRequest,
                cn.abstractmgs.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public cn.abstractmgs.HelloReply sayHello(cn.abstractmgs.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<cn.abstractmgs.HelloReply> sayHello(
        cn.abstractmgs.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((cn.abstractmgs.HelloRequest) request,
              (io.grpc.stub.StreamObserver<cn.abstractmgs.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cn.abstractmgs.HelloWorldProto.getDescriptor();
    }
